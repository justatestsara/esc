...
import { generateAdUrl } from '../../lib/utils'
...
export default function AdDetailClient({ adId, citySlug, isOldRoute }: AdDetailClientProps) {
  ...
  useEffect(() => {
    ...
    // If this is an old route and we found the model, redirect to the new SEO-friendly URL
    if (isOldRoute && foundModel && !citySlug) {
      const newUrl = generateAdUrl(foundModel.city, foundModel.id)
  ...
  }, [adId, isOldRoute, citySlug, router])
