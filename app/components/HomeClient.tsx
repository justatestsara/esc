...
export default function HomeClient() {
  ...
  }, [userLocation, searchParams, filtersInitialized])
      ...
      <div className="container mx-auto px-2 sm:px-4 py-3 sm:py-6 border-b border-[var(--border-primary)] transition-colors">
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-medium text-[var(--text-secondary)] mb-3">{t('filters.countries')}</h2>
          ...
          {availableCities.length > 0 && (
            <div className="space-y-2">
              <h2 className="text-sm font-medium text-[var(--text-secondary)] mb-3">{t('filters.cities')}</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
